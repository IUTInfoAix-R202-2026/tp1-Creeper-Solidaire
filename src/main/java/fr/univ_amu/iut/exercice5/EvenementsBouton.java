...
public class EvenementsBouton extends Application {
  ...
  public void start(Stage primaryStage) {
    ...
    Button bouton_clique_moi = new Button("Clique-moi");
    bouton_clique_moi.setId("bouton-clique-moi");
    Label labelCompteur = new Label("0 clics");
    labelCompteur.setId("compteur");
    // vbox
    VBox vbox = new VBox(10);
    vbox.getChildren().addAll(bouton_clique_moi, labelCompteur);
